...
export type EpubConverter = {
    ...
    convertEpub: (epub: Epub) => Promise<C.ActualBook>,
};
...
export function buffer2book(buffer: Buffer): Promise<C.ActualBook> {
...
function epub2book(epub: Epub): Promise<C.ActualBook> {
...
function resolveEpubConverter(epub: Epub): (epub: Epub) => Promise<C.ActualBook> {
